...
pred_log_prob_A = logistic_A.predict_proba(x_test_A)
...
pred_RF_prob = RF_1_A.predict_proba(x_test_A)
...
pred_log_prob_n= logistic_N.predict_proba(x_test_N)
...
pred_RF_prob_N = RF_1_N.predict_proba(x_test_N)
...
pred_log_prob_R= logistic_R.predict_proba(x_test_R)
...
pred_RF_prob_R = RF_1_R.predict_proba(x_test_R)
...
pred_log_prob_M= logistic_M.predict_proba(x_test_M)
...
pred_RF_prob_M = RF_1_M.predict_proba(x_test_M)
...
pred_RF_prob_t = RF_1_t.predict_proba(x_test_t)
precision_rf_t,recall_rf_t, thresholds = precision_recall_curve(y_test_t,pred_RF_prob_t[:,1])
auc_rf_t=auc(recall_rf_M,precision_rf_t)
print("AUC Score for Random Forest for ROBBERY ",auc_rf_t)
